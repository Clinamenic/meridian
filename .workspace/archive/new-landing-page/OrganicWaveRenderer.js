class OrganicWaveRenderer {
    ...
    onMouseDown(e) {
        // Only handle sphere rotation if clicking directly on the canvas, not on content
    ...
    onMouseMove(e) {
        ...
        this.currentRotation.y += deltaX * this.config.dragSensitivity * 0.01;
        this.currentRotation.x += deltaY * this.config.dragSensitivity * 0.01;
